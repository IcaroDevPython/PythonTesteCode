...
const url = "https://api.myip.com/" //"https://www.youtube.com/watch?v=P7ONGp24jEs"//"http://api.myip.com"//"https://twitter.com/i/flow/login"
...
async function startWebdriver() {
    await (async function () {
        ...
        chromeOptions.addArguments(`--proxy-server=${proxy_url}`);
